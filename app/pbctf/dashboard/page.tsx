...
export default async function DashboardPage() {
  ...
  return (
  <div className="min-h-screen bg-black text-green-300 px-4 py-8">
    <div className="max-w-4xl mx-auto space-y-8 w-full">

      <div className="bg-gray-900/30 border border-green-400/20 rounded-lg p-6 mb-8 space-y-6">
      ...
      <div className="bg-gray-800/30 border border-green-400/20 rounded-lg p-6">
        ...
        <div className="space-y-4">
          <div className="bg-gray-800/30 border border-green-400/20 rounded p-4">
            <p className="text-xl">{registration.participant1.name}</p>
            <p className="text-gray-400">
              {registration.participant1.email}
            </p>
          ...
          {registration.participant2 && (
            <div className="bg-gray-800/30 border border-green-400/20 rounded p-4">
              <p className="text-lg md:text-xl break-words">
                {registration.participant2.name}
              </p>

              <p className="text-gray-400 break-all text-sm md:text-base">
