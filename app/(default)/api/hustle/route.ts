 ...
 *     description: This route fetches contest data from VJudge API, updates the leaderboard, and stores it in the database.
 *     responses:
 *       200:
 ...
 *                 error:
 *                   type: string
 *                   example: Invalid response from VJudge
 *                 details:
 *                   type: string
 *                   example: No contest data available
 *       500:
 ...
 *                 details:
 *                   type: string
 *                   example: Internal server error or API error
 */
 ...
 *     description: This route fetches the latest contest results and leaderboard rankings from the database.
 *     responses:
 *       200:
