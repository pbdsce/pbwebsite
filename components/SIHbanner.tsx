            ...
            <Link href="https://sih.dsce.in/">
                <div className="relative group cursor-pointer">
                    <div className="bg-black/95 backdrop-blur-sm border-2 border-green-400/50 rounded-2xl shadow-2xl group-hover:border-green-300/80 group-hover:bg-black/98 transition-all duration-300 overflow-hidden relative">
                        <div className="bg-gradient-to-r from-green-900/50 via-green-900/50 to-green-900/50 px-6 py-6 relative border-b border-green-400/30">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    <div>
                                        <h2 className="text-green-300 font-bold text-lg tracking-wider">SMART INDIA HACKATHON.exe</h2>
                        ...
                        <div className="p-6 space-y-6 relative">
                            <div className="space-y-3">
                                <div className="text-green-300 font-mono text-sm border-b border-green-400/20 pb-2">
                                    &gt; MISSION_OBJECTIVES:
                                </div>
                            ...
                            <div className="pt-4 border-t border-green-400/20">
                                <div className="relative">
                                    <div className="bg-gradient-to-r from-green-600/80 via-green-600/80 to-green-600/80 text-white font-mono font-bold py-4 px-6 rounded-lg text-center group-hover:from-green-500/90 group-hover:to-green-500/90 transition-all duration-300 shadow-lg group-hover:shadow-green-400/20 border border-green-400/50">
                        ...
                        <div className="absolute top-4 left-4 w-4 h-4 border-t-2 border-l-2 border-green-400/60"></div>
                        <div className="absolute top-4 right-4 w-4 h-4 border-t-2 border-r-2 border-green-400/60"></div>
                        <div className="absolute bottom-4 left-4 w-4 h-4 border-b-2 border-l-2 border-green-400/60"></div>
                        <div className="absolute bottom-4 right-4 w-4 h-4 border-b-2 border-r-2 border-green-400/60"></div>
                    </div>
