...
const ParticipantForm: React.FC<ParticipantFormProps> = ({ 
  ...
  //replacing canResend from derieved state to computed to prevent re rendering(made necessary changes in timer effect)
...
//       resetOTPState();
//     }
//   }, [watchEmail, otpSent, otpVerified]);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <select
              ...
              className="w-full bg-gray-900/50 border border-green-400/30 rounded px-4 py-2 md:py-3 text-green-300 font-mono text-sm focus:border-green-400 focus:outline-none transition-colors"
            >
          ...
          <div className="md:col-span-2">
            ...
            >
              <option value="" className="bg-gray-900">
                {typeof window !== "undefined" && window.innerWidth < 640
                  ? "Previous CTF?"
                  : "Have you participated in CTFs before?"}
              </option>
