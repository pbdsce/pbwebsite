        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <select
              ...
              className="w-full bg-gray-900/50 border border-green-400/30 rounded px-2 md:px-4 py-2 md:py-3 text-green-300 font-mono text-sm focus:border-green-400 focus:outline-none transition-colors"
            >
