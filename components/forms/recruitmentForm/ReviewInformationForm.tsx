          ...
          <div className="bg-gray-900/30 border border-gray-700 rounded-xl p-6 space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-white font-medium">{formDataForSubmission.name}</p>
              </div>
              <div>
                <label className="text-sm text-gray-400">Email</label>
                <div className="flex items-center justify-between">
                  <p className="text-white font-medium truncate">{formDataForSubmission.email}</p>
              ...
              <div>
                ...
                <p className="text-white font-medium">{formDataForSubmission.branch}</p>
              </div>
              <div>
                <label className="text-sm text-gray-400">Year</label>
                <p className="text-white font-medium">{formDataForSubmission.year_of_study}</p>
              </div>
              <div>
                <label className="text-sm text-gray-400">
                  {formDataForSubmission.year_of_study === "1st year" ? "Admission Number" : "USN"}
                </label>
                <p className="text-white font-medium">{formDataForSubmission.college_id}</p>
              </div>
              <div>
                <label className="text-sm text-gray-400">WhatsApp</label>
                <p className="text-white font-medium">{formDataForSubmission.whatsapp_number}</p>
              </div>
            </div>
            <div>
              <label className="text-sm text-gray-400">About Yourself</label>
              <p className="text-white font-medium text-sm leading-relaxed">{formDataForSubmission.about}</p>
            </div>
          </div>
