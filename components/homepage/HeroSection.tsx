...
export default function HeroSection() {
  return (
    ...
    >
      <ThreeBackground />
      <div className="relative flex justify-center items-center min-h-[90vh] flex-col gap-12 px-4 sm:px-10 lg:px-24 py-32 lg:py-20 max-w-420 mx-auto w-full z-10">
        <h1
