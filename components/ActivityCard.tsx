 ...
 return (
   <section className="w-full py-20 bg-neutral-950 overflow-hidden">
     ...
     >
       ...
       {/* TEXT — constrained */}
       <div className="px-10 pu-10 lg:px-20">
         <div className="max-w-xl lg:ml-10">
           ...
           {subtitle && (
             <div className="mt-4 text-sm uppercase tracking-[0.55em] text-gray-500 pr-10">
               {subtitle}
             </div>
           )}


           <p className="mt-6 text-sm md:text-xl leading-[1.8] text-gray-500 pr-10">
             {description}
           </p>
         </div>
       </div>
